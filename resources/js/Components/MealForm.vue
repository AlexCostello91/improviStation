        ...
        <div class="space-y-12">
            <div class="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-3">
                ...
                <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
                    ...
                    <p v-if="form.errors.name && !form.name" class="mt-2 text-sm text-red-600" id="name-error">{{ form.errors.name }}</p>
                </div>
                ...
                <div class="col-span-full">
                    ...
                    <div class="mt-2">
                        <textarea v-model="form.desc" id="desc" name="desc" rows="3"
                ...
                <div class="col-span-full">
                    ...
                    <p class="mt-3 text-sm leading-6 text-gray-600">Public meals will be able to be seen and used by
                        other users, and they will be able to see who created it.</p>
                </div>
                <div class="col-span-full">
                    <label for="mealtype"
